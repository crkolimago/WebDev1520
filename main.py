...
import six
app = Flask(__name__)
CLIENT_ID = "259796801299-ghsf0r11p3hcpv2r6m2bgurll2pi1oo1.apps.googleusercontent.com"
CUR_USER = None
...
def profile():
        ...
        rewards = "42"
        phone = "555-555-5555"
        return render_template("profile.html", userName = name, rewardsNumber = rewards, emailAddress = email, phoneNumber = phone)
